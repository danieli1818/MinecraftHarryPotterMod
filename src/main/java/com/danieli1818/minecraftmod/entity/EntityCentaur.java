...
public class EntityCentaur extends EntityMob implements IRangedAttackMob {
    ...
    private static final DataParameter<Boolean> SWINGING_ARMS = EntityDataManager.<Boolean>createKey(EntityCentaur.class, DataSerializers.BOOLEAN);
    private final EntityAIAttackRangedBow<EntityCentaur> aiArrowAttack = new EntityAIAttackRangedBow<EntityCentaur>(this, 1.0D, 20, 15.0F);
    private final EntityAIAttackMelee aiAttackOnCollide = new EntityAIAttackMelee(this, 1.2D, false)
    {
        ...
        {
            super.resetTask();
            EntityCentaur.this.setSwingingArms(false);
        }
        /**
        ...
        public void startExecuting()
        {
            ...
            EntityCentaur.this.setSwingingArms(true);
        }
    };
...
//        }
    ...
    public static void registerFixesCentaur(DataFixer fixer, Class<?> entityClass)
    {
    ...
    {
    	Class<?> entityClass = EntityCentaur.class;
        EntityLiving.registerFixesMob(fixer, entityClass);
        fixer.registerWalker(FixTypes.ENTITY, new ItemStackData(entityClass, new String[] {"SaddleItem"}));
    }
