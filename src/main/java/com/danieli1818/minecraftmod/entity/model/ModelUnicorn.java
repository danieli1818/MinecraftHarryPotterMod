...
public class ModelUnicorn extends ModelBase {
    ...
    public ModelUnicorn()
    {
        ...
        this.shape40 = new ModelRenderer(this, 0, 12);
        this.shape40.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.shape40.addBox(-0.5F, -24.0F, 10.0F, 1, 10, 1, 0.0F);
        this.head.addChild(shape40);
    }
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        if (flag) {
        	this.shape40.isHidden = true;
        } else {
        	this.shape40.isHidden = false;
        }
...
//    	this.field_110684_D.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount;
